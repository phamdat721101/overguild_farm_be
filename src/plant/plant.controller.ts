...
export class PlantController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns all lands with plants, growth progress, health status, and time to wilt",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Water any plant to help it grow. Rate limit: 1 water per hour per plant",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Harvest fruits when plant reaches FRUIT stage. Clears the land for new planting.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: "Interact with plant (visit/social) - Legacy endpoint",
  })
  @ApiResponse({
    status: 200,
